...
uint32_t EMSCRIPTEN_KEEPALIVE PVRTDecompressPVRTC(const void* compressedData, uint32_t do2bitMode, uint32_t xDim, uint32_t yDim, uint8_t* outResultImage);
...
//     function("PVRTDecompressPVRTC", &PVRTDecompressPVRTC, allow_raw_pointers());
//     function("PVRTDecompressETC", &PVRTDecompressETC, allow_raw_pointers());
// }
//} // namespace pvr